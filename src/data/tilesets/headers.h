...
const struct Tileset gTileset_ValleySpring =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_ValleySpring,
    .palettes = gTilesetPalettes_ValleySpring,
    .metatiles = gMetatiles_ValleySpring,
    .metatileAttributes = gMetatileAttributes_ValleySpring,
    .callback = NULL,
};
