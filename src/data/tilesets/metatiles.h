...
const u16 gMetatiles_ValleySpring[] = INCBIN_U16("data/tilesets/primary/valleyspring/metatiles.bin");
const u16 gMetatileAttributes_ValleySpring[] = INCBIN_U16("data/tilesets/primary/valleyspring/metatile_attributes.bin");
