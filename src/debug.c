...
{
    [TIME_MIDNIGHT]         = { gTimeOfDayStringsTable[TIME_MIDNIGHT],      DebugAction_TimeMenu_ChangeTimeOfDay },
    ...
    [TIME_LATE_MORNING]     = { gTimeOfDayStringsTable[TIME_LATE_MORNING],  DebugAction_TimeMenu_ChangeTimeOfDay },
    [TIME_MIDDAY]           = { gTimeOfDayStringsTable[TIME_MIDDAY],        DebugAction_TimeMenu_ChangeTimeOfDay },
