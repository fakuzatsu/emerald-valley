...
//Time
#define OW_TIMES_OF_DAY                 GEN_VALLEY   // Different generations have the times of day change at different times.
...
#define OW_ALTERED_TIME_RATIO           GEN_VALLEY   // In GEN_8_PLA, the time in game moves forward 60 seconds for every second in the RTC. In GEN_9, it is 20 seconds. This has no effect if OW_USE_FAKE_RTC is FALSE.
